...
Base.@kwdef struct PackageBenchmarkSpec <: AbstractStudySpec
    ...
    output_dir::String = joinpath("julia", "simulations", "output", "package_benchmark", "smoke")
...
function package_benchmark_protected_roots(repo_root::String = package_benchmark_repo_root())
    return [
        joinpath(repo_root, "bin"),
        joinpath(repo_root, "docs"),
        joinpath(repo_root, "julia", "src"),
        joinpath(repo_root, "julia", "test"),
        joinpath(repo_root, "julia", "simulations", "data"),
