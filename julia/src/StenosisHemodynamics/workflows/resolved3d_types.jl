...
const DEFAULT_RESOLVED3D_DATA_ROOT = joinpath("julia", "simulations", "data", "3d", "canic_case3")
const DEFAULT_COMPARISON_OUTPUT_DIR = joinpath("julia", "simulations", "output", "3d_comparison")
