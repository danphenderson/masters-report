...
TARGET_BY_FOCUS = {
    "model_hierarchy": "sections/03-model-hierarchy/index.tex",
    "closures": "sections/04-modeling-closures/index.tex",
    "verification_well_balancing": "sections/05-numerical-methods/index.tex",
    "comparison_observation": "sections/07-case-study/comparison.tex",
}
...
def write_markdown(path: Path, rows: list[dict[str, object]]) -> None:
    ...
    lines = [
        ...
        "",
        "Scratch, non-excerpting support matrix generated from `references/source-inventory.tsv`,",
        "`references.bib`, and available local mirrors.",
        "",
        "## Counts",
        "",
    ]
