...
AXIS_TARGETS = {
    "model hierarchy": "sections/03-model-hierarchy/index.tex",
    "closures": "sections/04-modeling-closures/index.tex",
    "verification and well-balancing": "sections/05-numerical-methods/index.tex",
    "observation operators": "sections/05-numerical-methods/index.tex; sections/06-synthesis/index.tex",
    "clinical observables": "sections/04-modeling-closures/index.tex; sections/06-synthesis/index.tex",
    "learned methods": "sections/03-model-hierarchy/index.tex; sections/06-synthesis/index.tex",
...
def action_for(row: dict[str, str], known_bib_keys: set[str]) -> str:
    ...
    if bib_key not in known_bib_keys:
        return "metadata-first; bib_key is absent from references.bib"
...
def target_for(axis: str, evidence_rows: list[dict[str, str]]) -> str:
    ...
    return "; ".join(targets) if targets else "sections/06-synthesis/index.tex"
