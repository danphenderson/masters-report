...
$\partial_t\La_t(\vxi)=\vu(t,\La_t(\vxi))$ gives
\begin{flalign*}
    \quad \frac{d}{dt}\phi(t,\La_t(\vxi)) = \partial_t\phi(t,\vx)+\nabla\phi(t,\vx)\cdot\vu(t,\vx), \qquad \vx=\La_t(\vxi). &&
\end{flalign*}
The identity
\begin{flalign*}
...
also gives
\begin{flalign*}
    \quad D_t\phi=\partial_t\phi+\Div(\phi\vu)-\phi\Div\vu. &&
\end{flalign*}
...
\begin{flalign*}
    ...
    \partial_t\Jhatdet_t
    =
    \Jhatdet_t\,\mathrm{tr}\!\left(\partial_t\vFhat_t\,\vFhat_t^{-1}\right)
    =
...
\begin{flalign*}
    ...
    =
    \int_{V(t)}
    \left(\partial_t\phi+\Div(\phi\vu)\right)\dx. &&
\end{flalign*}
...
\begin{flalign*}
    ...
    =
    \int_{V(t)}\rho\left(\partial_t\vu+(\vu\cdot\nabla)\vu\right)dV. &&
\end{flalign*}
...
\begin{flalign*}
    \quad
    \partial_t(\rho\vu)+\Divbf(\rho\vu\otimes\vu)
    =
    \Divbf(\vT)+\rho\vfb &&
\end{flalign*}
...
\begin{flalign*}
    ...
    =
    \rho\left(\partial_t\vu+(\vu\cdot\nabla)\vu\right)
    +\vu\left(\partial_t\rho+\Div(\rho\vu)\right). &&
\end{flalign*}
