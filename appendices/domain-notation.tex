...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.22\linewidth}
        ...
        $\alpha$
            ...
            closure; the baseline flat-profile convention is $\alpha=1$
            & $-$ \\
        ...
        $z_c$ & preferred notation for center of the stenosis profile & $\mathrm{m}$ \\

        $z_s$ & alias for center of the stenosis profile used in legacy figures or prior notation & $\mathrm{m}$ \\

        $\ell_s$ & preferred notation for length of the stenosis profile & $\mathrm{m}$ \\

        $L_s$ & alias for length of the stenosis profile used in legacy figures or prior notation & $\mathrm{m}$ \\
        ...
        $-C_fQ/A$; first-run value $C_f=8\pi\eta/\rho$ & $\mathrm{m}^2/\mathrm{s}$ \\
        ...
        $\eta_{\mathrm{fric}}(z,t)$
            ...
            \(\eta_{\mathrm{fric}}=\eta_{\mathrm{eff}}(\dot\gamma_w)\) for the
            admitted Carreau--Yasuda wall-friction extension
            & $\mathrm{Pa}\cdot\mathrm{s}$ \\
