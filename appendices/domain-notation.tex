...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.22\linewidth}
        ...
        $\mathcal W$
            & wall descriptor; the selected 1D report model uses
            $\mathcal W_{\mathrm{elastic1D}}$, while fixed-wall and
            resolved-FSI wall models require separate declarations
            & mixed \\
