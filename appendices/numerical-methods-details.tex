...
\begin{flalign*}
    ...
    \left(
        Q,\,
        \left(\alpha_{\mathcal P}+\alpha_c(R_0'(z))\right)\frac{Q^2}{a}
...
\begin{flalign*}
    ...
    \alpha_{\mathrm{eff}}
    &=
        \alpha_{\mathcal P}+\alpha_c(R_0'(z)),\qquad
    u=\frac{Q}{a}, &&\\
    \quad
    \chi^2
    &=
...
The flat profile is not evaluated through that singular limit; it records
