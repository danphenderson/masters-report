...
\begin{flalign*}
    ...
    \right]. &&
\end{flalign*}
The $\widehat{\pd_z p_2}_i$ term is the discrete derivative of the Canic
variable-radius viscous pressure correction. It is tied to the
\texttt{canic-extended-1d} realization, while the elastic stiffness terms above
come from the selected Canic--Koiter wall law.
