...
comparison boundary in Sec.~\ref{subsec:model-hierarchy-comparison-boundary}. It is supporting
...
The active finite-volume record imposes one incoming boundary condition at each
boundary in the subcritical regime using the code's Riemann-invariant
construction. Let
\begin{flalign*}
    \quad
