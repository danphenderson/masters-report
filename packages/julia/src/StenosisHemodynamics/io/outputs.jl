...
function summary_lines(result::SimulationResult, p::Params, out::OutputSpec)
    ...
    lines = [
        ...
        "output_csv,$(out.csv)",
        "model,$(model_name(p))",
        "variable_radius_terms,$(variable_radius_terms_enabled(p))",
        "wall_law,$(wall_law_name(p))",
    ...
    append!(
        ...
        [
            ...
            "mass_initial,$(result.diagnostics.mass_initial)",
            "mass_final,$(result.diagnostics.mass_final)",
