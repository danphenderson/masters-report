# StenosisHemodynamics Julia Package

`StenosisHemodynamics` is the Julia solver package used by the report in this
...
- `packages/julia/Project.toml`
- `packages/julia/Manifest.toml`
- `packages/julia/src/StenosisHemodynamics.jl`
- `packages/julia/src/StenosisHemodynamics/**`
- `packages/julia/test/**`
...
module internals, for example `StenosisHemodynamics.run_study(...)`. The CLI
