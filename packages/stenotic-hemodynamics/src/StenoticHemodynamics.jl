...
include("StenoticHemodynamics/workflows/shared/parallel.jl")
...
include("StenoticHemodynamics/workflows/shared/workflow_values.jl")
include("StenoticHemodynamics/workflows/studies/studies.jl")
include("StenoticHemodynamics/workflows/studies/refinement.jl")
include("StenoticHemodynamics/workflows/native_resolved_fsi/native_resolved_fsi_mesh.jl")
include("StenoticHemodynamics/workflows/native_resolved_fsi/native_resolved_fsi_workflow.jl")
include("StenoticHemodynamics/workflows/native_resolved_fsi/native_resolved_fsi_restart.jl")
include("StenoticHemodynamics/workflows/resolved3d/resolved3d_types.jl")
...
include("StenoticHemodynamics/workflows/resolved3d/resolved3d_compare.jl")
include("StenoticHemodynamics/workflows/native_resolved_fsi/native_resolved_fsi_parity.jl")
include("StenoticHemodynamics/workflows/canic_replication/canic_replication.jl")
include("StenoticHemodynamics/workflows/visualization/visualization.jl")
include("StenoticHemodynamics/workflows/operator_validation/operator_validation.jl")
include("StenoticHemodynamics/workflows/resolved3d/resolved3d_outputs.jl")
include("StenoticHemodynamics/workflows/verification/stationary_stokes_refinement.jl")
include("StenoticHemodynamics/workflows/membrane_fsi/membrane_fsi_validation.jl")
include("StenoticHemodynamics/workflows/verification/verification.jl")
include("StenoticHemodynamics/workflows/geometry_exports/geometry_exports.jl")
include("StenoticHemodynamics/workflows/benchmarks/benchmarks.jl")
