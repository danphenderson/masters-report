...
function native_resolved_fsi_empty_solver_diagnostics()
    return (
        ...
        gridap_operator_component_status="not_evaluated",
        gridap_operator_component_terms="",
        gridap_solver_backend_status="not_evaluated",
        gridap_context_reused=false,
        gridap_model_reused=false,
        gridap_fe_spaces_reused=false,
        gridap_measures_reused=false,
        gridap_matrix_structure_stable="unknown",
        gridap_symbolic_factorization_eligible="unknown",
        gridap_symbolic_factorization_reused=false,
        gridap_symbolic_factorization_cache_status="not_evaluated",
        gridap_symbolic_factorization_setup_count=0,
        gridap_symbolic_factorization_reuse_count=0,
        gridap_numeric_factorization_reused=false,
        gridap_numeric_factorization_cache_status="not_evaluated",
        gridap_numeric_factorization_cache_key="",
        gridap_numeric_factorization_matrix_value_digest="",
        gridap_numeric_factorization_setup_count=0,
        gridap_numeric_factorization_reuse_count=0,
        gridap_reuse_reason_codes="not_evaluated",
        gridap_mesh_topology_digest="",
        gridap_coordinate_value_digest="",
        gridap_matrix_value_baseline_digest="",
        gridap_matrix_value_digest_observation_count=0,
        gridap_matrix_value_digest_unique_count=0,
        gridap_matrix_value_digest_current_count=0,
        gridap_matrix_value_digest_repeat_count=0,
        gridap_matrix_value_digest_history_tail="",
        gridap_reuse_boundary_mode="",
        gridap_reuse_quadrature_degree=0,
        gridap_reuse_matrix_rows=0,
        gridap_reuse_matrix_cols=0,
        gridap_reuse_matrix_nnz=0,
        ...
        gridap_pressure_reference="",
        gridap_wall_boundary_mode="",
        gridap_quadrature_degree=0,
        gridap_quadrature_sensitivity_degree=0,
