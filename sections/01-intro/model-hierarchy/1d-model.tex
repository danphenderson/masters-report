...
The selected 1D forward model is specified in
Section~\ref{subsec:selected-1d-forward-model}. There the retained fields
...
descriptors. Both use the selected
...
wall no-slip baseline in Definition~\ref{def:classical-no-slip-1d-baseline}.
