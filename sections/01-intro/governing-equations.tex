...
\begin{figure}[!htb]
    ...
    \caption{Model hierarchy for reading comparison claims. This report
    selects a 1D reduced forward model; 3D fixed-wall, resolved FSI,
...
\begin{table}[!htb]
    ...
    \begin{tabularx}{\textwidth}{@{}
        ...
        Numerical reference problems for 1D solvers
            & Scheme comparison, reproducibility expectations, and reproducibility
            context
            & Grid, timestep, flux and source choices, boundary states, field and
            scalar discrepancies
            & Evidence standard; does not grant solver parity to this report's code
