...
\begin{definition}[Wall and FSI closure catalog]
    ...
    \cite{FormaggiaMouraNobile2007Coupling}.
\end{definition}
...
\begin{definition}[Closed 1D area-flow model]
    ...
    \begin{flalign*}
        ...
        =
        \partial_Ap_{\mathrm g}(A,z,t)\partial_zA
        +
    ...
    gauge pressure closing the reduced system. This is the reduced
...
\begin{figure}[!htb]
    \centering
    \captionsetup{aboveskip=2pt,belowskip=2pt}
    \includegraphics[width=\textwidth]{figures/static/static/rendered/stenosis-3d-overview.pdf}
    \caption{Analytic three-dimensional rendering of the reference geometry in
    Definition~\ref{def:1d-stenosis-reference-geometry}. The smooth reference
    vessel is shown beside the default \(50\%\) narrowed vessel; both are
    idealized numerical geometries generated from the report profile, not
    patient-specific plaque morphology or clinical calibration.}
...
\begin{definition}[Conservative flux/source notation for the reduced wall law]
    ...
    \begin{flalign*}
        \quad
        \partial_A \Psi_{\mathcal W}(A,z,t)
        &=
        \frac{A}{\rho}\partial_A p_{\mathrm g}^{\mathcal W}(A,z,t), &&\\
        \quad
        S_{\mathrm{geom}}^{\mathcal W}(A,z,t)
        &=
        \left.\partial_z\Psi_{\mathcal W}(A,z,t)\right|_A
        -
        \frac{A}{\rho}
        \left.\partial_zp_{\mathrm g}^{\mathcal W}(A,z,t)\right|_A,
        &&\\
        \quad
        S_f^{\mathcal R}(A,Q,z)
        &=
