...
\begin{figure}[!htb]
    ...
    Panel (a) shows case 77 with 22,691 loaded nodes; panel (b) shows case 60
    with 21,975 loaded nodes. The shared color scale makes the stronger
    axial-velocity concentration in the 40\% case visible. Sparse arrows
    indicate local vector direction, and the transparent surface frames the 3D
    point cloud. These are resolved velocity-data renderings, not the
