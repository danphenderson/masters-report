...
reported study. The continuum blood-flow setting and governing-equation
baseline have already been fixed in Section~\ref{subsec:continuum-constitutive-assumptions}
and Section~\ref{subsec:governing-equations-model-hierarchy}; proof-level
transport identities remain in the appendices. The review here therefore
compares model tiers, closure choices, verification practice, and
