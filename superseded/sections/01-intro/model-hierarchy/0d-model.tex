...
canonical terminal examples: they supply an outlet impedance, downstream load,
or network closure for a local 1D, multiscale, or 3D vessel solve
...
velocity profile, no throat acceleration, and no recirculation region. It also
has no resolved wall-shear stress or wall traction, because it does not carry a
lumen surface, a stress tensor on that surface, or a wall-normal output operator.
