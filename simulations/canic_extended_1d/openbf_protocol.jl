...
function run_simulation(
    ...
    verbose && @info "running OpenBF-style CanicExtended1D simulation" project_name=spec.project_name cycles=spec.cycles inlet_period_s=spec.inlet_period_s output_directory=spec.output_directory
