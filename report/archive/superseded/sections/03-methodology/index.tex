...
\path{tmp/simulations/output/revision-*} or \path{tmp/revision-evidence/} and are
...
\path{public/var/data/simulations/canic_case3/}; the report archives the generated CSV
