...
idealizations, it can inspect radial velocity structure, throat acceleration,
simplified recirculation, and wall-shear trends that a 1D area--flow model
cannot resolve.
...
pipe-flow, and dimension-reduction background for this reading is supplied by
...
acceleration, radial profile structure, or simplified recirculation, but it is
not the selected forward generator and does not validate the 1D map by itself.
