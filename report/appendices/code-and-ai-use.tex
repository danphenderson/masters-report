...
archive. Large raw inputs should remain separate from the thesis PDF/source
archive unless a release plan explicitly assigns a data archive, checksum
record, and size budget. The retained Canic case3 XDMF/HDF5 bundle is tracked
in this source package as source-data input with checksum provenance; it is not
duplicated as a report asset.
...
retained as diagnostic-surface context rather than selected comparison evidence.
