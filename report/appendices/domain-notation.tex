...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.24\linewidth}
        ...
        $\mathcal W$ & wall descriptor; the selected report model uses the Canic--Koiter law & mixed \\
        ...
        $p_{\mathrm{loc},\mathrm g}^{\mathrm{diag}}$ & legacy local-denominator pressure diagnostic from the implementation helper & pressure \\
