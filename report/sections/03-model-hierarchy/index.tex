...
Table~\ref{tab:model-hierarchy-comparison} summarizes the hierarchy by state,
mathematical form, closure burden, data, observables, evidence target, and
principal interpretation limit. The table is intentionally organized around
state and observation rather than around individual papers. It is the reading
frame used by later closure, evidence, and synthesis chapters.

\begin{table}[!htb]
    \centering
    \tiny
    \setlength{\tabcolsep}{2pt}
    \caption{State, closure, data, observable, and evidence matrix for
    cardiovascular model tiers.}
    ...
    \begin{tabularx}{\textwidth}{@{}
        ...
        \textbf{Tier}
            ...
            & \textbf{Reconstructed}
            & \textbf{Evidence target}
            & \textbf{Limit} \\
        \midrule
        Fixed-wall 3D CFD
            & $\vu,p$ on prescribed lumen.
            & Navier--Stokes or Stokes PDE.
            & None in space.
            & Rheology, wall boundary, numerics.
            & Geometry and inlet/outlet data.
            & Velocity, pressure.
            & WSS indices, section means.
            & Local-field verification.
            & Wall motion and circulation are closed. \\
        Resolved FSI
            & Fluid fields plus wall state.
            & Coupled fluid/structure PDEs.
            & Structural idealization only.
            & Wall material, interface, mesh/ALE.
            & Wall data and coupling histories.
            & Displacement, traction, fields.
            & Scalar WSS or pressure diagnostics.
            & Coupled-interface behavior.
            & Many data/parameter inputs must be identified. \\
        Axisymmetric / 2D
            & Symmetry-constrained velocity, pressure.
            & Reduced spatial PDE.
            ...
            & Mechanism isolation.
            & Suppressed modes are not native. \\
        Distributed 1D
            & $A,Q,\bar u$, pressure/wall state.
            & Axial hyperbolic balance law.
            & Section averaging.
            & Profile, wall, friction, geometry, rheology.
            & Inlet/outlet, junctions, terminal beds.
            & Area, flow, mean velocity.
            & WSS proxies, radial profiles.
            & Pulse or stenosis comparison.
            & Local wall traction and transverse flow are closed. \\
        Lumped 0D
            & Pressures, volumes, flows.
            & ODE/algebraic network.
            ...
            & System interaction.
            & No native stenosis geometry or WSS. \\
        Geometrical multiscale
            & Tier-specific states plus interfaces.
            ...
            & Coupled-domain consistency.
            & Interface map can dominate interpretation. \\
        Solver surrogate/PINN/operator
            & Learned solution, parameter, or operator map.
            & Trained residual/data objective.
            ...
            & Generalization inside train/test domain.
            & Credibility is bounded by data-generating contract. \\
        \bottomrule
    \end{tabularx}
\end{table}
