...
requirements. The second summarizes observables, evidence role, and interpretation
limits. The split keeps the reading frame organized around state and
observation rather than around individual papers. Read each row as a claim
contract: what the tier solves natively, what it closes, what it can report
directly, and which evidence role its outputs can support.
