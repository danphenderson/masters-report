...
software traceability, or learned-model scope. Appendix~\ref{app:code-and-ai-use}
...
\begin{table}[!htb]
    ...
    \begin{tabularx}{\textwidth}{@{}
        ...
        Numerical benchmark or software
            & Scheme comparison, source-artifact reconstruction, workflow traceability.
...
observables; and software or repository materials support source-artifact
traceability rather than scientific truth of a model claim. The review does not claim exhaustive
...
\begin{enumerate}
    ...
    status, source-artifact traceability, and uncertainty sources are compared?
\end{enumerate}
...
validation, source-artifact traceability, and cross-dimensional observation operators. The
