...
\subsubsection{Numerical contract stack}
...
\subsubsection{Local stencil and coupling map}
...
wording in this report is therefore bounded to focused formulation-level and
smoke-test evidence for continuous P2-velocity/P1-pressure routes. That
evidence checks the local mathematical specification; it is not a
manuscript-grade reproduction or
