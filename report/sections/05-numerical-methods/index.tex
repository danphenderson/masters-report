...
residual equation. In finite differences it is induced by the grid points used
in difference quotients, in finite volumes by the cell averages and
reconstructed interface states used in numerical fluxes, and in finite elements
by basis functions whose supports overlap in the variational forms. Time
integration changes how these residuals are evaluated or solved; it does not by
itself change the spatial dependencies encoded in $R_h$, although an implicit
