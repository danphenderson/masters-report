...
and a declared velocity observation operator. It does not ask that state to
...
cost, identifiability, validation status, source-artifact traceability, and
uncertainty are compared. The answer is that interpretation depends on the declared equation,
