...
across model tiers. It supplies a concise template connecting retained state,
closures, boundary data, discretization, observation operator, metric, and
evidence type. It applies that template once in an idealized stenosis
computation.
