...
the local 1D target time taken from each imported XDMF time. Its output is a
separate source-artifact diagnostic table, not part of the primary two-case
localization claim. Pressure discrepancies in that comparison use the common
Section~4.1 outlet-gauge diagnostic and remain separate from the primary
velocity-observation result.
