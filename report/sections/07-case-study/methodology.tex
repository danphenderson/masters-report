...
rows using the same cut triangles. Those rows are treated as secondary output,
and no radial-profile figure or localization claim is retained because the
