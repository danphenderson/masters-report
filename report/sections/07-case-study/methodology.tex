...
\begin{table}[!htb]
    ...
    \begin{tabularx}{\textwidth}{@{}
        ...
        Observation operator
            ...
            reproducibility artifacts, not promoted localization evidence. A
            separate Section~4.1 source-artifact reproduction is tracked in
...
loader surfaces for the restored 23\%, 40\%, and 50\% upstream bundles, but it
is reported as a separate reproduced-asset table rather than as the primary
two-case localization claim.
