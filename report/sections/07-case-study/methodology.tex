...
\begin{table}[!htb]
    \centering
    \scriptsize
    \caption{Case-study specification for the retained 23\% and 40\%
    ...
    \begin{tabularx}{\textwidth}{@{}
        ...
        Observation operator
            ...
            the same plane cuts. Both retained coordinate modes use
            $T=0.9995$ s for the 23\% and 40\% stenosis cases.
            & The comparison supports a claim only for these common section
            observables. Radial-profile audit rows are supplemental
...
rows using the same cut triangles, and workflow diagnostics classify
...
Section~4.1 source-artifact workflow uses the same pressure and displacement
...
workflow is reported as a separate source-artifact diagnostic table rather than
as the primary two-case localization claim; pressure discrepancies remain
