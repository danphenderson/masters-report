...
Continuous compatibility does not imply discrete preservation: the
MUSCL/Rusanov scheme used here exhibits the reported non-well-balanced
geometry-rest drift.
...
$0.9995\,\mathrm{s}$, matching the imported final-time samples for the 23\% and
40\% cases; it is distinct from the $t=1.0\,\mathrm{s}$ zero-forcing rest-state
...
$T=0.9995$ s. The reported cases are described by their 23\% and 40\% stenosis
