...
This section states the mathematical specification used by the worked stenosis
example. It fixes the model tier, state variables, closure choices, boundary
approximation, finite-volume method, observation map, and comparison limits
before any result is interpreted. Detailed operator formulas, secondary
numerical checks, and reconstruction commands remain in the appendices unless
they are needed for a main-text claim. Table~\ref{tab:t1-case-study-contract}
gives the compact case-study specification used by the subsections below.
