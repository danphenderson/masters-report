...
\begin{table}[!htb]
    ...
    \begin{tabularx}{\textwidth}{@{}
        ...
        Resolved datasets and final-time match
            ...
            matching is not carried by the available comparison record and would be needed
        ...
        Principal 1D computation
            ...
            implementation-check or sensitivity context rather than the
...
\begin{definition}[Selected Canic--Koiter pressure--area wall law]
    ...
    $p_{\mathrm{loc},\mathrm g}^{\mathrm{diag}}$ through
    \path{pressure(result, params)}; benchmark pressure extrema and
    pressure-diagnostic bars refer to that diagnostic, not to
...
records the detailed source-to-implementation table. The diagnostic extended
