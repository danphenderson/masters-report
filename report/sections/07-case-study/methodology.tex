...
Notation~\ref{def:contract-role-symbol-map}. Table~\ref{tab:t1-case-study-contract}
states the comparison contract before the individual assumptions are used.
...
\begin{table}[!htb]
    ...
    \begin{tabularx}{\textwidth}{@{}
        ...
        Observation operator
            ...
            diagnostic artifacts, not localization evidence; Appendix~\ref{app:code-and-ai-use}
            documents the separate Section~4.1 source-artifact workflow. \\
        Numerical evidence
...
Appendix~\ref{app:code-and-ai-use} records the raw-input policy and the
separate Section~4.1 source-artifact workflow; those diagnostics are not part
of the primary two-case localization claim.
