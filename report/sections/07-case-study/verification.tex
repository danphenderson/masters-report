...
from the same geometry-rest state and use the same operator. The zero-inlet
magnitudes do not support a large through-flow interpretation, but the nonzero
localized residual means the production comparison is read as a diagnostic
section-mean velocity comparison, not as a clean production-grid
