...
The forcing consistency check is independent enough to test the declared
finite-volume operator rather than only replaying a stored output; the table
reports its maximum absolute mismatch. The run therefore checks the operator
against a declared manufactured state. It remains implementation-verification
evidence, not a physical stenosis experiment.
