...
preserve the sampled geometry-rest state exactly. The published Lax--Wendroff
row is retained as a diagnostic-surface capability boundary from that scratch
run: its residual decomposition attempted a $t=0$ flux evaluation with zero
native diagnostic timestep, while that flux requires a positive native time
step.
