...
Section~\ref{sec:numerical-methods} to the worked example. The main numerical
evidence has three parts: manufactured-solution verification supports the
forced finite-volume operator, the geometry-rest test exposes the
non-well-balanced limitation of the selected scheme, and the admissibility
diagnostics show that the accepted comparison runs stayed within the specified
...
scheme used here does not exactly preserve it. Boundary, CFL,
...
The observation operator has its own check because the 1D--3D
