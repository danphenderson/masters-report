...
reference-coordinate section observation operator, the 23\% case has mean absolute
...
operators. This interpretation remains conditional on the declared equation,
retained state, discretization, observation rule, and metric summarized in
