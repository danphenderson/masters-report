...
Radial-profile outputs are not used for a main-body localization claim because
the selected slices do not coincide with the retained 200-section axial target
set; the comparison remains a section-mean velocity comparison.
