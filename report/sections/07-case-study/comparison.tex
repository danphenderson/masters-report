...
diagnostics rather than clinical validation, pressure-ratio evidence, or full
transient FSI reproduction.
...
operators. Appendix~\ref{app:code-and-ai-use} governs the raw-input policy and
the separate Section~4.1 source-artifact workflow; restoring the ignored
XDMF/HDF5 inputs permits those supplemental diagnostics but does not regenerate
the article's raw transient 3D FSI solution. This interpretation remains
conditional on the specified equation, state variables, discretization,
observation rule, and metric summarized in
