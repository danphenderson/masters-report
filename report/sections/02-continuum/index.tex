...
that serve as the full-order reference model. Resolved, reduced, lumped,
...
provide the common language of the model hierarchy. A full-order continuum tier
evolves $\vu$ and $p$ on $\OmgBt$. A reduced one-dimensional tier stores
cross-sectional area, flow, and mean velocity obtained from these fields through
averaging and closure assumptions. The continuum setting therefore identifies the
