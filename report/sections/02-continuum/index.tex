...
three-dimensional field by cross-sectional variables. Let $S(z,t)$ denote the
lumen section at axial coordinate $z$, with wall motion incorporated into the
moving section. The physical area, physical flow, and section-mean axial
velocity are
\begin{flalign*}
    \quad
    A(z,t)
...
uses this cross-sectional bridge to explain why distributed 1D models inherit
...
Table~\ref{tab:continuum-principal-observables} records the main categories used
when a continuum field is compared with a reduced stenosis model.
...
by the selected closure, and velocity-profile descriptors.
