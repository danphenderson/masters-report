...
This chapter fixes the continuum vocabulary from which the later model
hierarchy is read. The aim is not to repeat a full mechanics derivation. It is
to record the progression from material motion to transport identities, balance
laws, stress closure, and incompressible flow equations. Resolved, reduced,
lumped, multiscale, and learned models differ in how much of this continuum
description they retain, close, observe, or approximate.
...
The idealized stenosis example later in the report uses this chapter only as a
...
observables: physical flow, section-mean axial velocity, pressure when a
pressure output is declared, and velocity-profile descriptors.
